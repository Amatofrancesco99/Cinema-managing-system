...
public class Room {
	...
	/**
	 * COTRUTTORE, inseriti il numero di righe e di colonne di una sala, esso genera
	 * tutti i posti
	 * 
	 ...
	 *                                        inseriti un numero di righe o colonne
	 *                                        valido
	 */
	...
	/**
	 * METODO per convertire un carattere (numero di una fila), in valore numerico
	 * da 0 a 25 si considera il fatto che la fila del cinema è un carattere, quindi
	 * una string con un solo elemento
	 * 
