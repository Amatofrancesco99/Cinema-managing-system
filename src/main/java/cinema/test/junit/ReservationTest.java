...
public class ReservationTest {
	...
	public void testCoupon() {
		...
		} catch (ReservationException | CouponException | SeatAvailabilityException | RoomException | PersistenceException e) {
			e.toString();
		}	
	}
	...
	* stessa */
	...
	public void testSendEmail() throws InvalidSpectatorInfoException {
		...
		} catch (ReservationException | SeatAvailabilityException | RoomException | PersistenceException e) {
			System.out.println(e.getMessage());
		}
		try {
